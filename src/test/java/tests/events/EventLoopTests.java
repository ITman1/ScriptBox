...
public class EventLoopTests {
	...
	private class Task_A_Duration_3  extends Task {
		...
		public Task_A_Duration_3(List<String> results, WindowBrowsingContext context) {
	...
	private class Task_B_Duration_1  extends Task_A_Duration_3 {
		...
		public Task_B_Duration_1(List<String> results, WindowBrowsingContext context) {
	...
	private class Task_C_EventLoopSpin  extends Task_A_Duration_3 {
		...
		public Task_C_EventLoopSpin(List<String> results, WindowBrowsingContext context) {
			super(results, context);
		}
	...
	@Test
	public void TestSpinEventLoopOrder() {
		...
		waitFor(8000);
		String expecteds[] = {"Task_B_start", "Task_B_end", "Task_C_start", "Task_A_start", "Task_A_end", "Task_B_start", "Task_B_end", "Task_C_end"};
	...
	@Test
	public void TestSpinEventLoopAbort() {
		BrowsingUnit browsingUnit = userAgent.openBrowsingUnit();
		WindowBrowsingContext context = browsingUnit.getWindowBrowsingContext();
		EventLoop eventLoop = browsingUnit.getEventLoop();
		List<String> results = new ArrayList<String>();
		...
		String expecteds[] = {"Task_A_start", "Task_A_end"};
		String[] actuals = results.toArray(new String[results.size()]);
		assertArrayEquals(expecteds, actuals);
